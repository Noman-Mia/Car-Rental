        ...
        <form class=" w-full" action="{{ route('cars.update', ['car' => $car->id]) }}" method="POST"
            ...
            <div class="md:w-2/3 w-5/6 md:px-24 px-4 pb-8 mx-auto mt-2 space-y-12 bg-white border-2 border-gray-600 rounded-md">
                ...
                <div class="flex items-center justify-center gap-x-6 mb-6">
                    ...
                    <button type="submit"
                        class="w-1/3 rounded-md bg-green-500 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-pr-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-pr-400">Save</button>
                </div>
