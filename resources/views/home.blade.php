        ...
        <div class="bg-sec-100 ">
            ...
            <div class="flex justify-center md:py-28 py-12 mx-auto max-w-screen-xl gap-x-3">
                <div class="flex  flex-col justify-center md:w-3/5  mx-12 md:ms-20 md:mx-0">
                    ...
                    <div class="flex justify-center md:justify-start mt-12 md:w-2/3 me-12 md:-ms-12">
                        <a href="/cars">
                            <button
                                class="bg-green-500 p-2 border-2 border-white rounded-md text-white hover:bg-pr-500 w-32 md:me-12 md:mx-12 mx-7 font-bold ">CARS</button>
                        </a>
                        <a href="/contact_us">
                            <button class="border-2 border-green-400 text-black w-32 p-2 rounded-md hover:bg-sec-400">CONTACT
                                US</button>
                        </a>
                    </div>
                </div>
            ...
            <div class="mx-auto max-w-screen-xl">
                <div class="flex align-middle justify-center">
                    ...
                    <p class="my-2 mx-8  p-2 font-car font-bold text-green-400 text-2xl ">CARS</p>
                ...
                <div class="   md:mr-16 mr-4 mb-4 flex justify-end">
                    <a href="/cars">
                        <button
                            class="border-2 border-green-400 text-black w-16 p-1 rounded-md hover:bg-green-500 hover:text-white">See
                            All</button>
                    </a>
                </div>
            </div>
                            ...
                            <div class="mt-2 mb-5 flex items-center justify-between">
                                ...
                                <div class="flex items-center">
                                    @for ($i = 0; $i < $car->stars; $i++)
                                        <svg aria-hidden="true" class="h-5 w-5 text-green-300" fill="currentColor"
                                    ...
                                    @endfor
                                    <span
                                        class="mr-2 ml-3 rounded bg-green-300 px-2.5 py-0.5 text-xs font-semibold">{{ $car->stars }}.0</span>
                                </div>
                            </div>
            ...
            <div class="mx-auto max-w-screen-xl mt-16 mb-32">
                <div>
                    <h2 class="text-center font-car text-3xl font-medium text-green-400"> <span
